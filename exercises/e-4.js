...
/* ---- E1.3. 
 ...
 "Felicidades NOMBRE APELLIDO, hoy cumples NUEVA_EDAD años"
*/

nombre = prompt("Tu nombre de usuario");
apellido = prompt("Tu primer apellido");
edad = prompt("Tu edad");
++edad;
console.log("Felicidades " + nombre + " " + apellido + ", hoy cumples " + edad + " años");